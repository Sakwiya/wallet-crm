					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a class="dropdown-item view_account" href="./?page=approve_transfer&transfer_id=<?php echo $row['transfer_id'] ?>">Approve</a>
		                      <div class="dropdown-divider"></div>
		                      <a class="dropdown-item" href="./?page=reject_transfer&id=<?php echo $row['transfer_id'] ?>">Reject</a>
		                    </div>
						</td>
					</tr>	
				<?php endwhile; ?>
