		...
		<div class="card-body">
			<table class="table table-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT a.*, CONCAT(a.firstname, ' ', a.lastname) AS name, b.branch_name, b.location FROM accounts AS a JOIN branches AS b ON a.branch_id = b.id WHERE type ='cooperative'");
					...
					<tr>
						...
						<td><b><?php echo ucwords($row['account_number']) ?></b></td>
						<td><b><?php echo $row['msisdn'] ?></b></td>
						<td><b><?php echo $row['branch_name'].', '.$row['location'] ?></b></td>
